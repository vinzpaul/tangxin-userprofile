    ...
    return (
        <ScrollView style={{
            ...
            <View style={{marginHorizontal: 30, alignItems: 'center'}}>
                <Image style={{width: 90, height: 90, borderRadius: 10}}
                       source={require('../../../assets/profilePhoto2.jpg')}/>
                <Text style={{color: '#FFFFFF', fontWeight: '600'}}>txvlog.com</Text>
                <Text style={{color: '#FFFFFF', fontWeight: '600', fontSize: 20, marginVertical: 15}}>服务条款</Text>
